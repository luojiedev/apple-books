# Apple Books Reading Archive — User Guide

[Back to README](../README_EN.md) · [简体中文](guide.md) · **English**

Detailed setup, export, and troubleshooting instructions. New users can begin with the [quick start](../README_EN.md#quick-start). Run the commands below from the project root.
